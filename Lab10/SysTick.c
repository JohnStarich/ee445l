...
#define SYSTICK_MILLIS 3000

// Initialize SysTick with busy wait running at bus clock.
void SysTick_Init(void){
  NVIC_ST_CTRL_R = 0;                   // disable SysTick during setup
  //NVIC_ST_RELOAD_R = 80000000 * SYSTICK_MILLIS / (160 * 1000);	// maximum reload value
  NVIC_ST_RELOAD_R = 500 * SYSTICK_MILLIS;	// maximum reload value
